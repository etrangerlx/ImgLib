...
bool ReszieFilter::DownScaleImage_4x(GrayImageBYTE *pInImge, GrayImageBYTE *pOutImage, int nInWidth, int nInHeight,
                                     int nInStride) {
...
bool
ReszieFilter::UpScaleImage_4x(GrayImageBYTE *pInImge, GrayImageBYTE *pOutImage, int nInWidth, int nInHeight, int nInStride) {
...
bool ReszieFilter::Process(GrayImageBYTE *pInImge, GrayImageBYTE *pOutImage) {
...
bool ReszieFilter::DownScale(GrayImageBYTE *pInImage, GrayImageBYTE *pOutImage) {
    int nOutWidth = pOutImage->GetWidth();
